...
CREATE TABLE users_table (
    ...
    scope JSON NOT NULL,            -- array of access levels, e.g. [buyer, retailer, manufacturer]
...
CREATE TABLE stores_table (
    ...
    net_worth LONGTEXT NOT NULL,                  -- Financial worth of the store (stringified)
    logo TEXT,                                    -- Logo URL
    wallet LONGTEXT NOT NULL,                     -- Wallet details (likely stringified JSON)
