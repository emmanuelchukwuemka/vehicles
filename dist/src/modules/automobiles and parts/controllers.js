...
const login = async (req, res) => {
    try {
        const validated = types_1.loginSchema.parse(req.body);
...
const refresh = async (req, res) => {
    try {
        const validated = types_1.refreshSchema.parse(req.body);
...
const logout = async (req, res) => {
    try {
        const validated = types_1.logoutSchema.parse(req.body);
...
const updateProfile = async (req, res) => {
    try {
        const validated = types_1.updateUserSchema.parse(req.body);
        const userId = req.user.id;
...
const createVehicle = async (req, res) => {
    try {
        const validated = types_1.createVehicleSchema.parse(req.body);
        const userId = req.user.id;
...
const updateVehicle = async (req, res) => {
    try {
        const validated = types_1.updateVehicleSchema.parse(req.body);
        const id = parseInt(req.params.id);
        const userId = req.user.id;
...
const addFavorite = async (req, res) => {
    try {
        const validated = types_1.addFavoriteSchema.parse(req.body);
        const userId = req.user.id;
...
const forgotPassword = async (req, res) => {
    try {
        const validated = types_1.forgotPasswordSchema.parse(req.body);
...
const resetPassword = async (req, res) => {
    try {
        const validated = types_1.resetPasswordSchema.parse(req.body);
