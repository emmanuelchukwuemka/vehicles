...
const continentControllers = __importStar(require("./continent.controllers"));
const continent_middlewares_1 = require("./continent.middlewares");
const router = (0, express_1.Router)();
router.post("/", continent_middlewares_1.validateCreatePayload, continentControllers.addContinent);
