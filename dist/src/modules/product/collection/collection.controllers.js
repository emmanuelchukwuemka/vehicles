...
exports.getCollectionsById = exports.getCollectionsByStore = exports.createCollection = void 0;
const collectionServices = __importStar(require("./collection.services"));
...
const getCollectionsByStore = async (req, res, next) => {
    try {
...
const getCollectionsById = async (req, res, next) => {
    try {
