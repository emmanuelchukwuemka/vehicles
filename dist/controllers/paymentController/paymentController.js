...
const stripe = require("stripe")("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");
...
const stripePayment = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        db.query(SQL, [userID, paymentIntent.client_secret, token, date], (error, result) => {
            if (error) {
                console.log(error);
            }
