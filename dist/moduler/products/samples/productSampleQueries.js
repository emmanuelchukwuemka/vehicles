...
//     }
// };
module.exports.getBasicProductSamples = async ({ pool, fields = ["*"], limit = 16, conditions = {}, // e.g. { store_id: 5 }
 }) => {
    const validFields = [
        "id",
        "store_id",
    ...
    const [rows] = await pool.query(`SELECT ${selected} FROM product_sample ${where} ORDER BY id DESC LIMIT ?`, params);
    return rows;
};
