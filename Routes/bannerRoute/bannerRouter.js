...
const {getBannerProducts,addBannerProducts,getBannertProductsByID,createBanner,deleteBanner,deactivateBanner,getBanner,getAppBanner,updateBanner } = require("../../Controllers/Banner/bannerController")
